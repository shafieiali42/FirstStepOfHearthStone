...
//    }
    ...
    public void buy(Cards card) throws IOException {
        ...
        for (Cards cardInBuyableCards : BuyableCards) {
            if (card.getName().equals(cardInBuyableCards.getName()) && this.money >= card.getMoneyCost()) {
                ...
                ControllerOfMainComponents.currentPlayer.getLoggerOfMyPlayer().info("Buy: " + card.getName());
    ...
    public void sell(Cards card) throws IOException {
        ...
        for (Cards cardInSalableCards : SalableCards) {
            if (card.getName().equals(cardInSalableCards.getName())) {
                ...
                ControllerOfMainComponents.currentPlayer.getLoggerOfMyPlayer().info("Sell: " + card.getName());
    ...
    public void selectHero(Heroes hero) throws IOException {
        if (!hero.getIsLock()) {
            ...
            setAvailableCardsWithThisSituation();
            ControllerOfMainComponents.currentPlayer.getLoggerOfMyPlayer().info("Select :" + hero.getName());
        } else {
                ...
                if (cardsInAvailableCardInThisSituation.getName().equals(card.getName())) {
                    switch (currentHero.getName()) {
                        case "Mage":
                            ...
                            ControllerOfMainComponents.currentPlayer.getLoggerOfMyPlayer().info("Add: " + card.getName() + "Heroe Name: Mage");
                            break;
                        case "Rogue":
                            ...
                            ControllerOfMainComponents.currentPlayer.getLoggerOfMyPlayer().info("Add: " + card.getName() + "Heroe Name: Rogue");
                            break;
                        case "Warlock":
                            ...
                            ControllerOfMainComponents.currentPlayer.getLoggerOfMyPlayer().info("Add: " + card.getName() + "Heroe Name: Warlock");
                            break;
        ...
        if (isThisCardInMyDeck) {
            switch (currentHero.getName()) {
                case "Mage":
                    ...
                    ControllerOfMainComponents.currentPlayer.getLoggerOfMyPlayer().info("Remove: " + card.getName() + "Heroe Name:Mage");
                    break;
                case "Rogue":
                    ...
                    ControllerOfMainComponents.currentPlayer.getLoggerOfMyPlayer().info("Remove: " + card.getName() + "Heroe Name: Rogue");
                    break;
                case "Warlock":
                    ...
                    ControllerOfMainComponents.currentPlayer.getLoggerOfMyPlayer().info("Remove: " + card.getName() + "Heroe Name: Warlock");
                    break;
            }
            setAvailableCardsThatWeCanAddIntoOurDeck();
        } else {
