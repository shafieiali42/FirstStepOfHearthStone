...
public class ShowCardsOnPanel {
    ...
    public static void showCards(ArrayList<Cards> cards, JPanel panel) throws IOException { //TODO init X and Y coordinate:((
        int counter = 0;
        int xCoordinate = 10;
        int yCoordinate = 10;
        int xSapce = 170;
        ...
        for (Cards card : cards) {
            ...
            if (counter % CardPanel.NUM_OF_CARD_IN_EVERY_ROW == 0) {
                xCoordinate = 10;
